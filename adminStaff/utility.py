...
def info_xls(request):
    ...
    proj_set = filter(lambda x: x.presubmit_set.all()[0].is_audited if x.project_category == CATE_INNOVATION else x.presubmitenterprise_set.all()[0].is_audited, proj_set)
