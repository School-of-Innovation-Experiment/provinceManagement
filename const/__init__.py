...
elif IS_DLUT_SCHOOL: MAJOR_CHOICES = DLUT_MAJOR_CHOICES
elif IS_SCHOOL_BASIC: MAJOR_CHOICES = DLUT_MAJOR_CHOICES
DLUT_SCHOOL_NAME = "大连理工大学"
MINZU_SCHOOL_NAME = "大连民族大学"
