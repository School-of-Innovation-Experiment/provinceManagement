...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('news_news', (
            ...
            ('news_date', self.gf('django.db.models.fields.DateField')(default=datetime.datetime(2013, 3, 26, 0, 0), blank=True)),
        ))
    ...
    models = {
        'news.news': {
            ...
            'news_date': ('django.db.models.fields.DateField', [], {'default': 'datetime.datetime(2013, 3, 26, 0, 0)', 'blank': 'True'}),
